...
| `test_pah_evolution_recovery.py` | 6 | `fit_evolving` sSFR-evolution recovery (shared η_A/η_g), static-model bias under evolution, 70 µm breaks the ratio degeneracy, null → reduces to `fit_shared`, `eta_prior_sigma` tames runaway, `evolution_recovery_sweep` unbiased + 70 µm helps |
