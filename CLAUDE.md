...
Tests use synthetic data with known injected fluxes — no real FITS or catalogs
required (except `test_integration.py`, which needs real maps and catalogs).
